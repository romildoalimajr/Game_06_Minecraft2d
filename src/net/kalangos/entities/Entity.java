...
public class Entity {
	...
	public static BufferedImage ENEMY_RIGHT = Game.spritesheet.getSprite(32, 16, 16, 16);
	public static BufferedImage ENEMY_LEFT = Game.spritesheet.getSprite(48, 16, 16, 16);
